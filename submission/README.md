...
<table>
<tr>
<td width="340" valign="top"><img src="media/hero_phone.png" width="300" alt="Biddesk Decision Card on a phone"></td>
<td valign="top">

**Live demo: <https://dpnzgd4gtjs45.cloudfront.net/web/>**

<img src="media/qr_live.png" width="180" alt="QR code for the live Biddesk demo">
...
<table>
<tr>
<td width="340" valign="top"><img src="media/flow.gif" width="300" alt="Screen recording of the live Biddesk demo on a phone viewport"></td>
<td width="340" valign="top"><img src="media/refusal.gif" width="300" alt="Screen recording of the guard refusing a submit"></td>
</tr>
</table>
...
<img src="request_path.svg" width="900" alt="Request path: phone to CloudFront to the Lambda Function URL proxy to AgentCore Runtime to Amazon Bedrock, with the SAM.gov API on the side">

The request path behind the live link; the full component diagram is [`architecture.svg`](architecture.svg).
